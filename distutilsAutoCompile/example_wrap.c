...
extern "C" {
#endif
SWIGINTERN int Swig_var_dval_set(PyObject *_val) {
  {
    double val;
    int res = SWIG_AsVal_double(_val, &val);
    if (!SWIG_IsOK(res)) {
      SWIG_exception_fail(SWIG_ArgError(res), "in variable '""dval""' of type '""double""'");
    }
    dval = (double)(val);
  }
  return 0;
...
SWIGINTERN PyObject *Swig_var_dval_get(void) {
  PyObject *pyobj = 0;
  
  pyobj = SWIG_From_double((double)(dval));
  return pyobj;
}


SWIGINTERN int Swig_var_fval_set(PyObject *_val) {
  {
    float val;
    int res = SWIG_AsVal_float(_val, &val);
    if (!SWIG_IsOK(res)) {
      SWIG_exception_fail(SWIG_ArgError(res), "in variable '""fval""' of type '""float""'");
    }
    fval = (float)(val);
  }
  return 0;
...
SWIGINTERN PyObject *Swig_var_fval_get(void) {
  PyObject *pyobj = 0;
  
  pyobj = SWIG_From_float((float)(fval));
  return pyobj;
}
...
# endif
  ...
  Py_DECREF(globals);
  SWIG_addvarlink(globals, "dval", Swig_var_dval_get, Swig_var_dval_set);
  SWIG_addvarlink(globals, "fval", Swig_var_fval_get, Swig_var_fval_set);
#if PY_VERSION_HEX >= 0x03000000
  return m;
#else
  return;
